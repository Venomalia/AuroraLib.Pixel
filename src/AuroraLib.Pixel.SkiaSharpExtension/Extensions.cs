...
namespace AuroraLib.Pixel.SkiaSharpExtension
{
    public static class Extensions
    {
        ...
        public static IImage AsAuroraImage(this SKPixmap pixmap) => pixmap.ColorType switch
        {
            ...
            SKColorType.RgbaF16 => AsAuroraImage<RGBAf16>(pixmap),
            SKColorType.RgbaF16Clamped => AsAuroraImage<RGBAf16>(pixmap),
            SKColorType.RgbaF32 => AsAuroraImage<RGBAf32>(pixmap),
