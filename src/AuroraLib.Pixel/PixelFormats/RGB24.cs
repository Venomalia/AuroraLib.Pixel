...
{
    /// <summary>
    /// Also known as RGB888, represents a 24-bit RGB color, where each component (R, G, B) is an 8-bit value.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct RGB24 : IRGB<byte>, IColor<RGB24>
    {
        /// <inheritdoc cref="IColor.FormatInfo"/>
        public static readonly PixelFormatInfo FormatInfo = new PixelFormatInfo(24, 8, 0, 8, 8, 8, 16);
        ...
        /// <inheritdoc/>
        public readonly bool Equals(RGB24 other) => Packed == other.Packed;

        /// <inheritdoc/>
        public readonly override bool Equals(object? obj) => obj is RGB24 other && Equals(other);

        /// <inheritdoc/>
        public readonly override int GetHashCode() => Packed.GetHashCode();

        /// <inheritdoc/>
        public override readonly string ToString() => $"{nameof(RGB24)}({R}, {G}, {B})";
