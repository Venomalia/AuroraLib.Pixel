...
{
    /// <summary>
    /// Represents a generic RGB (Red, Green, Blue) pixel format,
    ...
    public struct RGB<TValue> : IRGB<TValue>, IColor<RGB<TValue>> where TValue : unmanaged, IEquatable<TValue>, IComparable<TValue>
...
#endif
    {
        ...
        static RGB()
        {
            ...
            FormatInfo = new PixelFormatInfo((byte)(size * 3), size, 0, size, size, size, (byte)(size * 2), 0, 0, PixelFormatInfo.ColorSpaceType.RGB, ScaleHelper<TValue>.GetChannelType());
        }
        ...
        public RGB(TValue r, TValue g, TValue b)
        {
            R = r;
            G = g;
            B = b;
        ...
        /// <inheritdoc/>
        public readonly bool Equals(RGB<TValue> other)
            => R.Equals(other.R) && G.Equals(other.G) && B.Equals(other.B);

        /// <inheritdoc/>
        public override readonly bool Equals(object? obj) => obj is RGB<TValue> rGBA && Equals(rGBA);
        ...
        public override readonly string ToString()
            => $"{nameof(RGB<TValue>)}{Unsafe.SizeOf<TValue>() * 24}{ScaleHelper<TValue>.GetTypeName()}({R}, {G}, {B})";
        ...
        public static bool operator ==(RGB<TValue> left, RGB<TValue> right) => left.Equals(right);
        public static bool operator !=(RGB<TValue> left, RGB<TValue> right) => !(left == right);
    }
}
